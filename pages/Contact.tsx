...
${formState.message}
    ...
    const mailtoURL = `mailto:hr@vtpl.org.in?subject=${encodeURIComponent(
      subject
      ...
      <section className="bg-[#0B1F3A] py-24 text-white text-center">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto font-medium">
            Reach out for official quotations, tender queries, or technical
            consultations.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
            {offices.map((office, idx) => (
              <div
                key={idx}
                className={`bg-white p-10 rounded-xl border transition-all ${
                  office.isMain
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <input
                    ...
                    className="w-full px-5 py-4 rounded-md border bg-slate-50 focus:ring-2 focus:ring-blue-600 outline-none font-medium"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`accent-bg text-white w-full py-5 rounded-md font-bold uppercase tracking-widest transition-all shadow-xl ${
                    loading
            ...
            <div className="h-full min-h-[500px] rounded-2xl overflow-hidden shadow-sm border border-grey">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3314.757452285303!2d85.31990487532381!3d23.354687378942447!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e143b43dd149%3A0x1b31b1fd027ccf53!2sVikash%20Techsec%20Private%20Limited!5e1!3m2!1sen!2sin!4v1769754831446!5m2!1sen!2sin"
                className="w-full h-full"
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title="Vikash Techsec Private Limited - Ranchi Office"
              />
            </div>
          </div>
        </div>
